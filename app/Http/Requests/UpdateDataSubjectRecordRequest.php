...
class UpdateDataSubjectRecordRequest extends FormRequest
{
    ...
    {
        return [
            'record_code' => 'required|string|unique:data_subject_records,record_code,' . $this->route('record')->id . '|max:255',
            'full_name' => 'required|string|max:255',
            'email' => 'required|email|unique:data_subject_records,email,' . $this->route('record')->id . '|max:255',
